...
module.exports = function (ctx) {
  ...
  return {
    ...
    build: {
      ...
      publicPath: process.env.NODE_ENV === 'production' ? `/sitemodder@${pkg.version}/dist/` : env.PUBLIC_PATH,
      vueRouterBase: process.env.NODE_ENV === 'production' ? `/sitemodder@${pkg.version}/dist/` : env.APP_BASE,
